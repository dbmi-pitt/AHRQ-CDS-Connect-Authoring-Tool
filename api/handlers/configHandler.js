...
const conversionsELMFile = require('../data/library_helpers/ELMFiles/CDSConnectConversions-v1.json');

// If new functions are added to CDSConnectConversions and a separate description is desired, add a key value
